...
if($_POST['g-recaptcha-response'] == null || !isset($_POST['g-recaptcha-response']) || $_POST['g-recaptcha-response'] == ''){
    ...
    return;
}elseif(isset($_POST['correo']) && isset($_POST['nombre']) && isset($_POST['celular']) && isset($_POST['mensaje']) && isset($_POST['asunto'])){
    ...
    $secret = '6LdgiDApAAAAAP_6AFHiFX-jG2u5r0NLEhxxdHQU';
    ...
    if($result->success){
        ...
        $subject = 'Formulario de contacto | Dianalisis';
