...
if($_POST['g-recaptcha-response'] == null || !isset($_POST['g-recaptcha-response']) || $_POST['g-recaptcha-response'] == ''){
    ...
    return;
}elseif(isset($_POST['correo']) && isset($_POST['nombre']) && isset($_POST['celular']) && isset($_POST['mensaje']) && isset($_POST['asunto']) && isset($_POST['empresa'])){
    ...
    $secret = '6LfJm-0oAAAAAKdaXowkP3RPqYiVuRevfsyYogcX';
    ...
    if($result->success){
        ...
        $subject = 'Formulario Reysaltransport';
